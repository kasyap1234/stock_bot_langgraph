"""
Configuration settings for stock trading bot.
...
# LLM Configuration - Updated to use Groq models: Kimi K2 and Qwen 2.5-72B only
...
# NIFTY 50 stocks for broader analysis
...
# New Advanced Indicators Configuration
ICHIMOKU_PERIODS = {
...
# VPVR (Volume Profile Visible Range) Parameters
VPVR_BINS = 50
VISIBLE_RANGE = 200
...
# Harmonic Patterns Parameters
HARMONIC_PATTERNS = ['gartley', 'butterfly']
TOLERANCE = 0.05
LOOKBACK = 100
MIN_CONFIDENCE = 0.7

# HMM (Hidden Markov Model) Parameters
HMM_STATES = 3
HMM_ITER = 100
...
# Advanced Technical Analysis Features Flag
